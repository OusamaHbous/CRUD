...
namespace CRUDTests
{
  public class PersonsServiceTest
  {
    ...
    //First: here we are adding few persons, and then when we call GetAllPersons(), it should return the same persons that were added
    [Fact]
    ...
    //First: we are adding few persons, and then we will search based on person name with some search string. It should return the matching persons
    [Fact]
    ...
    //First: here we are adding a new person and then trying to update the person name and email
    [Fact]
