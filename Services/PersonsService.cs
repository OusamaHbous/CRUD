...
namespace Services
{
  public class PersonsService : IPersonsService
  {
    ...
    public PersonResponse AddPerson(PersonAddRequest? personAddRequest)
    {
      ...
      //converting personAddRequest into Person type
      Person person = personAddRequest.ToPerson();

      //generating PersonID
      person.PersonID = Guid.NewGuid();

      //adding person object to persons list
    ...
    public List<PersonResponse> GetAllPersons()
    {
      ...
      //the list of persons from the execute method will be converted into list of PersonResponse
      //and the return type will be PersnoRespons eventually
